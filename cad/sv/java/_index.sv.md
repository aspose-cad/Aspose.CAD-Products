---
title: Java AutoCAD API | Bearbeta och konvertera AutoCAD-filer 
weight: 950
url: /sv/java/ 
description: AutoCAD-bibliotek för att öppna och konvertera DWG- och DXF-ritfiler till PDF PNG GIF BMP JPEG- och TIFF-bildformat i java-applikationer
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java AutoCAD Conversion APIs" h2="Konvertera DWG, DXF, STL-dokument till PDF- och rasterbildsformat utan någon CAD-programvara." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cad/headers/aspose_cad-for-java.svg" pfName="Aspose.CAD" subTitlepfName="for Java" downloadUrl="https://downloads.aspose.com/cad/java" >}}

{{< blocks/products/pf/main-container pfName="Aspose.CAD" subTitlepfName="for Java" >}}

{{< blocks/products/pf/i18n/sub-menu logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cad/aspose_cad-for-java.svg" liveDemosLink="https://products.aspose.app/cad/family" PricingLink="https://purchase.aspose.com/pricing/cad/java" buyLink="https://purchase.aspose.com/buy" docsLink="https://docs.aspose.com/cad/java/" installationsDocsLink="https://docs.aspose.com/cad/java/installation/" nugetLink="" nugetPackageName="Fast layout:" mavenRepoLink="https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cad" directDownloadLink="https://downloads.aspose.com/cad/java" >}}
...
{{< blocks/products/pf/carousel-item h3="En överblick" description="En översikt över de huvudsakliga konverterings- och renderingsmöjligheterna för API." >}}
...
{{< blocks/products/pf/carousel-item h3="Plattformsoberoende" description="Aspose.CAD för Java stöder JDK 1.6 och högre." >}}
<div class="diagram1 d1-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img alt="AutoCAD Java-bibliotek" src="https://www.aspose.cloud/templates/aspose/img/products/cad/aspose_cad-for-java.svg"/>
  <header>
   Aspose.CAD
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Filformat som stöds" description="API [filformat som stöds](https://docs.aspose.com/cad/java/supported-file-formats/)  are listed below." >}}
<div class="diagram1 d2 d1-java">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img alt="Java CAD Processing API:er" src="https://www.aspose.cloud/templates/aspose/img/products/cad/aspose_cad-for-java.svg"/>
  <header>
   Aspose.CAD
  </header>
  <footer>
  ...
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <div class="codeblock" id="code">
     ...
     <pre><code class="java">// ladda CAD för konvertering
...
{{< blocks/products/pf/slr-element name="Källkod" href="https://github.com/aspose-cad/Aspose.CAD-for-Java" >}}
{{< blocks/products/pf/slr-element name="API-referenser" href="https://apireference.aspose.com/java/cad/" >}}
{{< blocks/products/pf/slr-element name="Handledningsvideor" href="https://www.youtube.com/user/asposevideo" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Produktsupport" tabId="support" >}}
{{< blocks/products/pf/slr-element name="Gratis support" href="https://forum.aspose.com/c/cad" >}}
{{< blocks/products/pf/slr-element name="Betald support" href="https://helpdesk.aspose.com/" >}}
{{< blocks/products/pf/slr-element name="Blogg" href="https://blog.aspose.com/category/cad/" >}}
{{< blocks/products/pf/slr-element name="Release Notes" href="https://docs.aspose.com/cad/java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Varför Aspose.CAD för Java?" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.CAD " description="Aspose.CAD erbjuder individuella inbyggda API:er för andra populära utvecklingsmiljöer enligt listan nedan:" >}}

    {{< blocks/products/pf/offers-section-item link="/cad/sv/net/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/cad/aspose_cad-for-net.svg" sdkName=".NET" >}}
