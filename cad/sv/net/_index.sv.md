...
weight: 330
url: /sv/net/ 
description: C# ASP.NET VB.NET AutoCAD-bibliotek för att öppna och konvertera DWG DXF-ritdokument till PDF PNG GIF BMP JPEG- och TIFF-format
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1=".NET API:er för att konvertera AutoCAD-filer" h2="Konvertera DWG- och DXF-filer till PDF- och rasterbilder utan någon AutoCAD-programvara." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cad/headers/aspose_cad-for-net.svg" pfName="Aspose.CAD" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/cad/net" >}}
...
{{< blocks/products/pf/carousel-item h3="Plattformsoberoende" description="CAD API stöder .NET Core och .NET framework inklusive ASP.NET och Windows-applikation." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/carousel-item h3="Supported File Formats" description="Aspose.CAD for .NET [filformat som stöds](https://docs.aspose.com/cad/net/supported-file-formats/)  listas nedan." >}}
  ...
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <div class="codeblock" id="code">
     ...
     <pre><code class="cs">// ladda ritningen som ska konverteras
...
{{< blocks/products/pf/slr-element name="Källkod" href="https://github.com/aspose-cad/Aspose.CAD-for-.NET" >}}
{{< blocks/products/pf/slr-element name="API-referenser" href="https://apireference.aspose.com/cad/net" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Varför Aspose.CAD för .NET?" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.CAD " description="Aspose.CAD erbjuder individuella inbyggda API:er för andra populära utvecklingsmiljöer enligt listan nedan:" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/cad/sv/java/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/cad/aspose_cad-for-java.svg" sdkName="Java" >}}
