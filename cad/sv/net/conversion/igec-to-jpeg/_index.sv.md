---
title: Konvertera IGEC till JPEG via C# 
url: /sv/net/conversion/igec-to-jpeg/ 
description: Exempelkod för konvertering av IGEC till JPEG C#. Använd API-exempelkod för batch-IGEC-filer till JPEG-konvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera IGEC till JPEG via C#" h2="Konvertera omedelbart IGEC till JPEG utan att behöva AutoCAD® eller någon annan renderingsprogramvara." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="CAD" fileiconsmall4="XML" fileiconsmall5="IGEC" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera IGEC till JPEG via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Denna exempelkod visar IGEC till JPEG C#-konvertering" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app för att konvertera IGEC till JPEG" sectionDescription="Check our live demos for [IGEC to JPEG conversion](https://products.aspose.app/cad/conversion/igec-to-jpeg) with following benefits." >}}
