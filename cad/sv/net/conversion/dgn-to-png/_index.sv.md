---
title: Konvertera DGN till PNG via C# 
url: /sv/net/conversion/dgn-to-png/ 
description: Exempelkod för konvertering av DGN till PNG C#. Använd API-exempelkod för batch-DGN-filer till PNG-konvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera DGN till PNG via C#" h2="Konvertera omedelbart DGN till PNG utan att behöva AutoCAD® eller någon annan renderingsprogramvara." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="CAD" fileiconsmall4="XML" fileiconsmall5="DGN" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera DGN till PNG via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Denna exempelkod visar DGN till PNG C#-konvertering" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app för att konvertera DGN till PNG" sectionDescription="Check our live demos for [DGN to PNG conversion](https://products.aspose.app/cad/conversion/dgn-to-png) with following benefits." >}}
