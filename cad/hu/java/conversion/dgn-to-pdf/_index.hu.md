---
title: A DGN konvertálása PDF-re Java segítségével 
url: /hu/java/conversion/dgn-to-pdf/ 
description: Java konverziós kód minta DGN formátumhoz PDF fájllá. Ezzel a példakóddal konvertálhatja a DGN-t PDF-vé bármely webes vagy asztali Java alapú alkalmazásban.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="A DGN konvertálása PDF-re Java segítségével" h2="Natív Java könyvtár a DGN olvasásához, írásához és exportálásához PDF-be Adobe nélkül." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PDF" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DGN" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a DGN konvertálásához PDF-vé Java segítségével" %}}
...
{{% blocks/products/pf/agp/code-block title="DGN-ből PDF Java konverziós forráskód" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ingyenes alkalmazás a DGN konvertálásához PDF-vé" sectionDescription="[Convert DGN to PDF](https://products.aspose.app/cad/conversion/dgn-to-pdf) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
