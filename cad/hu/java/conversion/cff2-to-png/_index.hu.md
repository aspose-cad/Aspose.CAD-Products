---
title: A CFF2 konvertálása PNG-re Java segítségével 
url: /hu/java/conversion/cff2-to-png/ 
description: Java konverziós kód minta CFF2 formátumhoz PNG fájllá. Ezzel a példakóddal konvertálhatja a CFF2-t PNG-vé bármely webes vagy asztali Java alapú alkalmazásban.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="A CFF2 konvertálása PNG-re Java segítségével" h2="Natív Java könyvtár a CFF2 olvasásához, írásához és exportálásához PNG-be Adobe nélkül." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CFF2" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a CFF2 konvertálásához PNG-vé Java segítségével" %}}
...
{{% blocks/products/pf/agp/code-block title="CFF2-ből PNG Java konverziós forráskód" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ingyenes alkalmazás a CFF2 konvertálásához PNG-vé" sectionDescription="[Convert CFF2 to PNG](https://products.aspose.app/cad/conversion/cff2-to-png) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
