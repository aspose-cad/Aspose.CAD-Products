---
title: A PLT konvertálása PNG-re Java segítségével 
url: /hu/java/conversion/plt-to-png/ 
description: Java konverziós kód minta PLT formátumhoz PNG fájllá. Ezzel a példakóddal konvertálhatja a PLT-t PNG-vé bármely webes vagy asztali Java alapú alkalmazásban.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="A PLT konvertálása PNG-re Java segítségével" h2="Natív Java könyvtár a PLT olvasásához, írásához és exportálásához PNG-be Adobe nélkül." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PLT" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a PLT konvertálásához PNG-vé Java segítségével" %}}
...
{{% blocks/products/pf/agp/code-block title="PLT-ből PNG Java konverziós forráskód" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ingyenes alkalmazás a PLT konvertálásához PNG-vé" sectionDescription="[Convert PLT to PNG](https://products.aspose.app/cad/conversion/plt-to-png) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
