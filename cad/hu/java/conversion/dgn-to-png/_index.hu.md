---
title: A DGN konvertálása PNG-re Java segítségével 
url: /hu/java/conversion/dgn-to-png/ 
description: Java konverziós kód minta DGN formátumhoz PNG fájllá. Ezzel a példakóddal konvertálhatja a DGN-t PNG-vé bármely webes vagy asztali Java alapú alkalmazásban.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="A DGN konvertálása PNG-re Java segítségével" h2="Natív Java könyvtár a DGN olvasásához, írásához és exportálásához PNG-be Adobe nélkül." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DGN" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a DGN konvertálásához PNG-vé Java segítségével" %}}
...
{{% blocks/products/pf/agp/code-block title="DGN-ből PNG Java konverziós forráskód" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ingyenes alkalmazás a DGN konvertálásához PNG-vé" sectionDescription="[Convert DGN to PNG](https://products.aspose.app/cad/conversion/dgn-to-png) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
