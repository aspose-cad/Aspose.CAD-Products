---
title: Konvertieren Sie CFF2 über Java in JPEG 
url: /de/java/conversion/cff2-to-jpeg/ 
description: Beispiel-Java-Konvertierungscode für das CFF2-Format in eine JPEG-Datei. Verwenden Sie diesen Beispielcode, um CFF2 in JPEG in jeder Web- oder Desktop-Java-basierten Anwendung zu konvertieren.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie CFF2 über Java in JPEG" h2="Native Java-Bibliothek zum Lesen, Schreiben und Exportieren von CFF2 in JPEG, ohne dass Adobe erforderlich ist." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="JPEG" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CFF2" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von CFF2 in JPEG über Java" %}}
...
{{% blocks/products/pf/agp/code-block title="CFF2-zu-JPEG-Java-Konvertierungsquellcode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Kostenlose App zum Konvertieren von CFF2 in JPEG" sectionDescription="[Convert CFF2 to JPEG](https://products.aspose.app/cad/conversion/cff2-to-jpeg) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
