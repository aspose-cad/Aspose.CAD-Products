---
title: Konvertieren Sie IGES über Java in BMP 
url: /de/java/conversion/iges-to-bmp/ 
description: Beispiel-Java-Konvertierungscode für das IGES-Format in eine BMP-Datei. Verwenden Sie diesen Beispielcode, um IGES in BMP in jeder Web- oder Desktop-Java-basierten Anwendung zu konvertieren.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie IGES über Java in BMP" h2="Native Java-Bibliothek zum Lesen, Schreiben und Exportieren von IGES in BMP, ohne dass Adobe erforderlich ist." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="BMP" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="IGES" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von IGES in BMP über Java" %}}
...
{{% blocks/products/pf/agp/code-block title="IGES-zu-BMP-Java-Konvertierungsquellcode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Kostenlose App zum Konvertieren von IGES in BMP" sectionDescription="[Convert IGES to BMP](https://products.aspose.app/cad/conversion/iges-to-bmp) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
