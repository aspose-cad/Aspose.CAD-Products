---
title: Converti IFC in DXF tramite Java 
url: /it/java/conversion/ifc-to-dxf/ 
description: Esempio di codice di conversione Java per il formato IFC in file DXF. Utilizzare questo codice di esempio per convertire IFC in DXF all'interno di qualsiasi applicazione basata su Java Web o Desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti IFC in DXF tramite Java" h2="Libreria Java nativa per leggere, scrivere ed esportare IFC in DXF senza bisogno di Adobe." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DXF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DXF" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="IFC" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire IFC in DXF tramite Java" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="App gratuita per convertire IFC in DXF" sectionDescription="[Convert IFC to DXF](https://products.aspose.app/cad/conversion/ifc-to-dxf) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
