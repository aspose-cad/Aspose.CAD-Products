...
weight: 330
url: /pl/net/ 
description: Biblioteka C# ASP.NET VB.NET AutoCAD do otwierania i konwertowania dokumentów rysunków DWG DXF do formatu PDF PNG GIF BMP JPEG i TIFF
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Interfejsy API .NET do konwersji plików AutoCAD" h2="Konwertuj pliki DWG i DXF na pliki PDF i obrazy rastrowe bez oprogramowania AutoCAD." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cad/headers/aspose_cad-for-net.svg" pfName="Aspose.CAD" subTitlepfName="for .NET" downloadUrl="https://releases.aspose.com/cad/net" >}}
...
{{< blocks/products/pf/carousel-item h3="Niezależność od platformy" description="CAD API obsługuje platformę .NET Core i .NET, w tym ASP.NET i aplikację Windows." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/carousel-item h3="Supported File Formats" description="Aspose.CAD for .NET [obsługiwane formaty plików](https://docs.aspose.com/cad/net/supported-file-formats/)  są wymienione poniżej." >}}
  ...
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <div class="codeblock" id="code">
     ...
     <pre><code class="cs">// załaduj rysunek do przekonwertowania
...
{{< blocks/products/pf/slr-element name="Dokumentacja" href="https://docs.aspose.com/cad/net/" >}}
{{< blocks/products/pf/slr-element name="Kod źródłowy" href="https://github.com/aspose-cad/Aspose.CAD-for-.NET" >}}
{{< blocks/products/pf/slr-element name="Referencje API" href="https://apireference.aspose.com/cad/net" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Dlaczego Aspose.CAD dla .NET?" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.CAD " description="Aspose.CAD oferuje indywidualne natywne interfejsy API dla innych popularnych środowisk programistycznych wymienionych poniżej:" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/cad/pl/java/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/cad/aspose_cad-for-java.svg" sdkName="Java" >}}
