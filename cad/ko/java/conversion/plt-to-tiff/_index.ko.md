...
{{% blocks/products/pf/agp/content h2="Java를 사용하여 PLT를 TIFF로 변환하는 방법" %}}

PLT를 TIFF로 렌더링하기 위해 우리는 기능이 풍부하고 강력하며 쉬운 <a href=https://products.aspose.com/cad/java>Aspose.CAD for Java</a> API를 사용할 것입니다. Java 플랫폼용 변환 API를 사용합니다. <a href=https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cad>Maven</a> 및 pom.xml에 다음 구성을 추가하여 Maven 기반 프로젝트 내에 설치합니다.
...
{{% blocks/products/pf/agp/feature-section-col title="Java를 통해 PLT를 TIFF로 변환하는 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="PLT에서 TIFF로의 Java 변환 소스 코드" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="PLT를 TIFF로 변환하는 무료 앱" sectionDescription="[Convert PLT to TIFF](https://products.aspose.app/cad/conversion/plt-to-tiff) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
