...
PLT를 GIF로 렌더링하기 위해 우리는 기능이 풍부하고 강력하며 쉬운 <a href=https://products.aspose.com/cad/java>Aspose.CAD for Java</a> API를 사용할 것입니다. Java 플랫폼용 변환 API를 사용합니다. <a href=https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cad>Maven</a> 및 pom.xml에 다음 구성을 추가하여 Maven 기반 프로젝트 내에 설치합니다.
