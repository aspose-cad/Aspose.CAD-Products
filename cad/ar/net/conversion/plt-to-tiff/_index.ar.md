---
title: تحويل PLT إلى TIFF عبر C # 
url: /ar/net/conversion/plt-to-tiff/ 
description: رمز عينة لتحويل PLT إلى TIFF C #. استخدم رمز مثال API لملفات PLT الدفعية لتحويل TIFF داخل VB.NET أو Asp.NET أو أي تطبيق قائم على .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل PLT إلى TIFF عبر C #" h2="قم بتحويل PLT إلى TIFF على الفور دون الحاجة إلى AutoCAD® أو أي برنامج عرض آخر." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="CAD" fileiconsmall4="XML" fileiconsmall5="PLT" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل PLT إلى TIFF عبر C #" %}}
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا تحويل PLT إلى TIFF C #" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="تطبيق مجاني لتحويل PLT إلى TIFF" sectionDescription="Check our live demos for [PLT to TIFF conversion](https://products.aspose.app/cad/conversion/plt-to-tiff) with following benefits." >}}
