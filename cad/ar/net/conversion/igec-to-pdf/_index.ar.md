---
title: تحويل IGEC إلى PDF عبر C # 
url: /ar/net/conversion/igec-to-pdf/ 
description: رمز عينة لتحويل IGEC إلى PDF C #. استخدم رمز مثال API لملفات IGEC الدفعية لتحويل PDF داخل VB.NET أو Asp.NET أو أي تطبيق قائم على .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل IGEC إلى PDF عبر C #" h2="قم بتحويل IGEC إلى PDF على الفور دون الحاجة إلى AutoCAD® أو أي برنامج عرض آخر." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="CAD" fileiconsmall4="XML" fileiconsmall5="IGEC" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل IGEC إلى PDF عبر C #" %}}
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا تحويل IGEC إلى PDF C #" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="تطبيق مجاني لتحويل IGEC إلى PDF" sectionDescription="Check our live demos for [IGEC to PDF conversion](https://products.aspose.app/cad/conversion/igec-to-pdf) with following benefits." >}}
