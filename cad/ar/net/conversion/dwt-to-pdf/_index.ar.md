---
title: تحويل DWT إلى PDF عبر C # 
url: /ar/net/conversion/dwt-to-pdf/ 
description: رمز عينة لتحويل DWT إلى PDF C #. استخدم رمز مثال API لملفات DWT الدفعية لتحويل PDF داخل VB.NET أو Asp.NET أو أي تطبيق قائم على .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل DWT إلى PDF عبر C #" h2="قم بتحويل DWT إلى PDF على الفور دون الحاجة إلى AutoCAD® أو أي برنامج عرض آخر." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="CAD" fileiconsmall4="XML" fileiconsmall5="DWT" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل DWT إلى PDF عبر C #" %}}
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا تحويل DWT إلى PDF C #" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="تطبيق مجاني لتحويل DWT إلى PDF" sectionDescription="Check our live demos for [DWT to PDF conversion](https://products.aspose.app/cad/conversion/dwt-to-pdf) with following benefits." >}}
