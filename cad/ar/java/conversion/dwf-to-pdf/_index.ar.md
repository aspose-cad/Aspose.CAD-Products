---
title: قم بتحويل DWF إلى PDF عبر Java 
url: /ar/java/conversion/dwf-to-pdf/ 
description: نموذج كود تحويل Java لتنسيق DWF إلى ملف PDF. استخدم رمز المثال هذا لتحويل DWF إلى PDF داخل أي تطبيق يستند إلى Web أو Desktop Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="قم بتحويل DWF إلى PDF عبر Java" h2="مكتبة Java الأصلية لقراءة وكتابة وتصدير DWF إلى PDF دون الحاجة إلى Adobe." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PDF" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DWF" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل DWF إلى PDF عبر Java" %}}
...
{{% blocks/products/pf/agp/code-block title="DWF إلى شفرة مصدر تحويل جافا PDF" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="تطبيق مجاني لتحويل DWF إلى PDF" sectionDescription="[Convert DWF to PDF](https://products.aspose.app/cad/conversion/dwf-to-pdf) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
