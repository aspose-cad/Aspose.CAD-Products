---
title: قم بتحويل DWG إلى TIFF عبر Java 
url: /ar/java/conversion/dwg-to-tiff/ 
description: نموذج كود تحويل Java لتنسيق DWG إلى ملف TIFF. استخدم رمز المثال هذا لتحويل DWG إلى TIFF داخل أي تطبيق يستند إلى Web أو Desktop Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="قم بتحويل DWG إلى TIFF عبر Java" h2="مكتبة Java الأصلية لقراءة وكتابة وتصدير DWG إلى TIFF دون الحاجة إلى Adobe." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="TIFF" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DWG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل DWG إلى TIFF عبر Java" %}}
...
{{% blocks/products/pf/agp/code-block title="DWG إلى شفرة مصدر تحويل جافا TIFF" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="تطبيق مجاني لتحويل DWG إلى TIFF" sectionDescription="[Convert DWG to TIFF](https://products.aspose.app/cad/conversion/dwg-to-tiff) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
