---
title: قم بتحويل DGN إلى PDF عبر Java 
url: /ar/java/conversion/dgn-to-pdf/ 
description: نموذج كود تحويل Java لتنسيق DGN إلى ملف PDF. استخدم رمز المثال هذا لتحويل DGN إلى PDF داخل أي تطبيق يستند إلى Web أو Desktop Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="قم بتحويل DGN إلى PDF عبر Java" h2="مكتبة Java الأصلية لقراءة وكتابة وتصدير DGN إلى PDF دون الحاجة إلى Adobe." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PDF" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DGN" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل DGN إلى PDF عبر Java" %}}
...
{{% blocks/products/pf/agp/code-block title="DGN إلى شفرة مصدر تحويل جافا PDF" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="تطبيق مجاني لتحويل DGN إلى PDF" sectionDescription="[Convert DGN to PDF](https://products.aspose.app/cad/conversion/dgn-to-pdf) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
