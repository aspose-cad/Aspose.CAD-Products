---
title: قم بتحويل IGES إلى PDF عبر Java 
url: /ar/java/conversion/iges-to-pdf/ 
description: نموذج كود تحويل Java لتنسيق IGES إلى ملف PDF. استخدم رمز المثال هذا لتحويل IGES إلى PDF داخل أي تطبيق يستند إلى Web أو Desktop Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="قم بتحويل IGES إلى PDF عبر Java" h2="مكتبة Java الأصلية لقراءة وكتابة وتصدير IGES إلى PDF دون الحاجة إلى Adobe." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PDF" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="IGES" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل IGES إلى PDF عبر Java" %}}
...
{{% blocks/products/pf/agp/code-block title="IGES إلى شفرة مصدر تحويل جافا PDF" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="تطبيق مجاني لتحويل IGES إلى PDF" sectionDescription="[Convert IGES to PDF](https://products.aspose.app/cad/conversion/iges-to-pdf) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
