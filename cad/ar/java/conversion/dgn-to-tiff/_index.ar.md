---
title: قم بتحويل DGN إلى TIFF عبر Java 
url: /ar/java/conversion/dgn-to-tiff/ 
description: نموذج كود تحويل Java لتنسيق DGN إلى ملف TIFF. استخدم رمز المثال هذا لتحويل DGN إلى TIFF داخل أي تطبيق يستند إلى Web أو Desktop Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="قم بتحويل DGN إلى TIFF عبر Java" h2="مكتبة Java الأصلية لقراءة وكتابة وتصدير DGN إلى TIFF دون الحاجة إلى Adobe." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="TIFF" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DGN" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل DGN إلى TIFF عبر Java" %}}
...
{{% blocks/products/pf/agp/code-block title="DGN إلى شفرة مصدر تحويل جافا TIFF" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="تطبيق مجاني لتحويل DGN إلى TIFF" sectionDescription="[Convert DGN to TIFF](https://products.aspose.app/cad/conversion/dgn-to-tiff) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
