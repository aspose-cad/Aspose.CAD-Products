---
title: قم بتحويل STL إلى DXF عبر Java 
url: /ar/java/conversion/stl-to-dxf/ 
description: نموذج كود تحويل Java لتنسيق STL إلى ملف DXF. استخدم رمز المثال هذا لتحويل STL إلى DXF داخل أي تطبيق يستند إلى Web أو Desktop Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="قم بتحويل STL إلى DXF عبر Java" h2="مكتبة Java الأصلية لقراءة وكتابة وتصدير STL إلى DXF دون الحاجة إلى Adobe." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DXF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DXF" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="STL" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل STL إلى DXF عبر Java" %}}
...
{{% blocks/products/pf/agp/code-block title="STL إلى شفرة مصدر تحويل جافا DXF" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="تطبيق مجاني لتحويل STL إلى DXF" sectionDescription="[Convert STL to DXF](https://products.aspose.app/cad/conversion/stl-to-dxf) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
