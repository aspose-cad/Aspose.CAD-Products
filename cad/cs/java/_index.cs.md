---
title: Java AutoCAD API | Zpracování a převod souborů AutoCAD 
weight: 950
url: /cs/java/ 
description: Knihovna AutoCAD pro otevírání a převod souborů výkresů DWG a DXF do obrazových formátů PDF PNG GIF BMP JPEG a TIFF v aplikacích Java
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java AutoCAD Conversion API" h2="Převádějte dokumenty DWG, DXF, STL do formátu PDF a rastrových obrázků bez jakéhokoli CAD softwaru." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cad/headers/aspose_cad-for-java.svg" pfName="Aspose.CAD" subTitlepfName="for Java" downloadUrl="https://releases.aspose.com/cad/java" >}}

{{< blocks/products/pf/main-container pfName="Aspose.CAD" subTitlepfName="for Java" >}}

{{< blocks/products/pf/i18n/sub-menu logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cad/aspose_cad-for-java.svg" liveDemosLink="https://products.aspose.app/cad/family" PricingLink="https://purchase.aspose.com/pricing/cad/java" buyLink="https://purchase.aspose.com/buy" docsLink="https://docs.aspose.com/cad/java/" installationsDocsLink="https://docs.aspose.com/cad/java/installation/" nugetLink="" nugetPackageName="Pevné rozvržení:" mavenRepoLink="https://repository.aspose.com/cad/" directDownloadLink="https://releases.aspose.com/cad/java" >}}
...
{{< blocks/products/pf/carousel-item h3="Nezávislost na platformě" description="Aspose.CAD for Java podporuje JDK 1.6 a vyšší." >}}
<div class="diagram1 d1-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img alt="Java knihovna AutoCADu" src="https://www.aspose.cloud/templates/aspose/img/products/cad/aspose_cad-for-java.svg"/>
  <header>
   Aspose.CAD
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Podporované formáty souborů" description="API [podporované formáty souborů](https://docs.aspose.com/cad/java/supported-file-formats/)  are listed below." >}}
  ...
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <div class="codeblock" id="code">
     ...
     <pre><code class="java">// načíst CAD pro konverzi
...
{{< blocks/products/pf/slr-element name="Dokumentace" href="https://docs.aspose.com/cad/java/" >}}
{{< blocks/products/pf/slr-element name="Zdrojový kód" href="https://github.com/aspose-cad/Aspose.CAD-for-Java" >}}
{{< blocks/products/pf/slr-element name="Reference API" href="https://apireference.aspose.com/java/cad/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Proč Aspose.CAD pro Javu?" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.CAD " description="Aspose.CAD nabízí jednotlivá nativní rozhraní API pro další populární vývojová prostředí, jak je uvedeno níže:" >}}

    {{< blocks/products/pf/offers-section-item link="/cad/cs/net/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/cad/aspose_cad-for-net.svg" sdkName=".NET" >}}
