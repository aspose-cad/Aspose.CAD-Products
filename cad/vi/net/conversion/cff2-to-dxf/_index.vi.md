...
Để chuyển đổi CFF2 thành DXF, chúng tôi sẽ sử dụng API <a href=https://products.aspose.com/cad/net> Aspose.CAD cho .NET </a>, đây là một API giàu tính năng, mạnh mẽ và dễ sử dụng thao tác tài liệu và API chuyển đổi cho nền tảng C #. Mở trình quản lý gói <a href=https://www.nuget.org/packages/aspose.cad> NuGet </a>, tìm kiếm Aspose.CAD và cài đặt. Bạn cũng có thể sử dụng lệnh sau từ Bảng điều khiển Trình quản lý Gói.
