---
title: Convierta DXF a DXF a través de C# 
url: /es/net/conversion/dxf-to-dxf/ 
description: Código de muestra para la conversión de DXF a DXF C#. Utilice el código de ejemplo de API para la conversión de archivos DXF por lotes a DXF dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta DXF a DXF a través de C#" h2="Convierta instantáneamente DXF a DXF sin necesidad de AutoCAD® o cualquier otro software de renderizado." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DXF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="CAD" fileiconsmall4="XML" fileiconsmall5="DXF" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir DXF a DXF a través de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra la conversión de DXF a DXF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicación gratuita para convertir DXF a DXF" sectionDescription="Check our live demos for [DXF to DXF conversion](https://products.aspose.app/cad/conversion/dxf-to-dxf) with following benefits." >}}
