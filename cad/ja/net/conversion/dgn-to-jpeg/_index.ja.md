---
title: C＃を介してDGNをJPEGに変換します 
url: /ja/net/conversion/dgn-to-jpeg/ 
description: DGNからJPEGC＃への変換のサンプルコード。 VB.NET、Asp.NET、または任意の.NETベースのアプリケーション内でのバッチDGNファイルからJPEGへの変換にAPIサンプルコードを使用します。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="C＃を介してDGNをJPEGに変換します" h2="AutoCAD®やその他のレンダリングソフトウェアを必要とせずに、DGNをJPEGに即座に変換します。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="CAD" fileiconsmall4="XML" fileiconsmall5="DGN" >}}
...
DGNをJPEGに変換するために、機能が豊富で強力な<a href=https://products.aspose.com/cad/net> Aspose.CAD for .NET</a>APIを使用します。 C＃プラットフォーム用の使いやすいドキュメント操作および変換API。 <a href=https://www.nuget.org/packages/aspose.cad> NuGet </a>パッケージマネージャーを開き、Aspose.CADを検索してインストールします。パッケージマネージャーコンソールから次のコマンドを使用することもできます。
...
{{% blocks/products/pf/agp/feature-section-col title="C＃を介してDGNをJPEGに変換する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="このサンプルコードは、DGNからJPEGへのC＃変換を示しています" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="DGNをJPEGに変換する無料アプリ" sectionDescription="Check our live demos for [DGN to JPEG conversion](https://products.aspose.app/cad/conversion/dgn-to-jpeg) with following benefits." >}}
