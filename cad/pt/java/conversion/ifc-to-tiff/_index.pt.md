...
{{% blocks/products/pf/agp/feature-section-col title="Passos para converter IFC para TIFF via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão Java IFC para TIFF" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicativo gratuito para converter IFC para TIFF" sectionDescription="[Convert IFC to TIFF](https://products.aspose.app/cad/conversion/ifc-to-tiff) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
