---
title: Converter CF2 para TIFF via Java 
url: /pt/java/conversion/cf2-to-tiff/ 
description: Exemplo de código de conversão Java para o formato CF2 para arquivo TIFF. Use este código de exemplo para converter CF2 em TIFF em qualquer aplicativo baseado em Java Web ou Desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter CF2 para TIFF via Java" h2="Biblioteca Java nativa para ler, escrever e exportar CF2 para TIFF sem precisar da Adobe." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="TIFF" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CF2" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para converter CF2 para TIFF via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão Java CF2 para TIFF" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicativo gratuito para converter CF2 para TIFF" sectionDescription="[Convert CF2 to TIFF](https://products.aspose.app/cad/conversion/CF2-to-tiff) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
