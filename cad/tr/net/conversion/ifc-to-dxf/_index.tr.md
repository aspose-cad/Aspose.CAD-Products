---
title: IFC'yi C# ile DXF'ye dönüştürün 
url: /tr/net/conversion/ifc-to-dxf/ 
description: IFC'den DXF'ye C# dönüştürme için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu IFC dosyalarının DXF'ye dönüştürülmesi için API örnek kodunu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="IFC'yi C# ile DXF'ye dönüştürün" h2="AutoCAD® veya başka herhangi bir işleme yazılımına ihtiyaç duymadan anında IFC'yi DXF'ye dönüştürün." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DXF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="CAD" fileiconsmall4="XML" fileiconsmall5="IFC" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# ile IFC'yi DXF'ye Dönüştürme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, IFC'den DXF'ye C# Dönüşümünü gösterir" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="IFC'yi DXF'ye Dönüştürmek için Ücretsiz Uygulama" sectionDescription="Check our live demos for [IFC to DXF conversion](https://products.aspose.app/cad/conversion/ifc-to-dxf) with following benefits." >}}
