---
title: DWG'yi C# ile DXF'ye dönüştürün 
url: /tr/net/conversion/dwg-to-dxf/ 
description: DWG'den DXF'ye C# dönüştürme için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu DWG dosyalarının DXF'ye dönüştürülmesi için API örnek kodunu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="DWG'yi C# ile DXF'ye dönüştürün" h2="AutoCAD® veya başka herhangi bir işleme yazılımına ihtiyaç duymadan anında DWG'yi DXF'ye dönüştürün." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DXF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="CAD" fileiconsmall4="XML" fileiconsmall5="DWG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# ile DWG'yi DXF'ye Dönüştürme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, DWG'den DXF'ye C# Dönüşümünü gösterir" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="DWG'yi DXF'ye Dönüştürmek için Ücretsiz Uygulama" sectionDescription="Check our live demos for [DWG to DXF conversion](https://products.aspose.app/cad/conversion/dwg-to-dxf) with following benefits." >}}
