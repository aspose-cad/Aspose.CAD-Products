---
title: Java ile DXF'yi PDF'ye dönüştürün 
url: /tr/java/conversion/dxf-to-pdf/ 
description: DXF formatı için PDF dosyasına örnek Java dönüştürme kodu. Herhangi bir Web veya Masaüstü Java tabanlı uygulamada DXF'yi PDF'ye dönüştürmek için bu örnek kodu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Java ile DXF'yi PDF'ye dönüştürün" h2="Adobe'ye ihtiyaç duymadan DXF'yi Okumak, Yazmak ve PDF'ye Dışa Aktarmak için Yerel Java Kitaplığı." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PDF" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DXF" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak DXF'yi PDF'ye Dönüştürme" %}}

DXF'yi PDF'ye dönüştürmek için, zengin özelliklere sahip, güçlü ve kolay bir <a href=https://products.aspose.com/cad/java>Aspose.CAD for Java</a> API'sini kullanacağız. Java platformu için dönüşüm API'sini kullanmak. En son sürümünü doğrudan <a href=https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cad>Maven</a> adresinden indirebilirsiniz ve pom.xml dosyasına aşağıdaki konfigürasyonları ekleyerek Maven tabanlı projenize kurun.
...
{{% blocks/products/pf/agp/feature-section-col title="Java ile DXF'yi PDF'ye Dönüştürme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="DXF'den PDF'ye Java Dönüştürme Kaynak Kodu" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="DXF'yi PDF'ye Dönüştürmek için Ücretsiz Uygulama" sectionDescription="[Convert DXF to PDF](https://products.aspose.app/cad/conversion/dxf-to-pdf) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
