---
title: Java AutoCAD API'si'si | AutoCAD Dosyalarını İşleyin ve Dönüştürün 
weight: 950
url: /tr/java/ 
description: DWG ve DXF çizim dosyalarını açmak ve java uygulamalarında PDF PNG GIF BMP JPEG ve TIFF görüntü formatlarına dönüştürmek için AutoCAD kütüphanesi
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java AutoCAD Dönüştürme API'leri" h2="Herhangi bir CAD yazılımı olmadan DWG, DXF, STL belgelerini PDF ve raster görüntü formatlarına dönüştürün." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cad/headers/aspose_cad-for-java.svg" pfName="Aspose.CAD" subTitlepfName="for Java" downloadUrl="https://downloads.aspose.com/cad/java" >}}
...
<div class="diagram1 d1-java">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img alt="Java AutoCAD API'si" src="https://www.aspose.cloud/templates/aspose/img/products/cad/aspose_cad-for-java.svg"/>
  <header>
   Aspose.CAD
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Platform Bağımsızlığı" description="Aspose.CAD for Java, JDK 1.6 ve üstünü destekler." >}}
<div class="diagram1 d1-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img alt="AutoCAD Java Kitaplığı" src="https://www.aspose.cloud/templates/aspose/img/products/cad/aspose_cad-for-java.svg"/>
  <header>
   Aspose.CAD
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Desteklenen Dosya Formatları" description="API [desteklenen dosya biçimleri](https://docs.aspose.com/cad/java/supported-file-formats/)  are listed below." >}}
<div class="diagram1 d2 d1-java">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img alt="Java CAD İşleme API'leri" src="https://www.aspose.cloud/templates/aspose/img/products/cad/aspose_cad-for-java.svg"/>
  <header>
   Aspose.CAD
  </header>
  <footer>
  ...
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <div class="codeblock" id="code">
     ...
     <pre><code class="java">// dönüştürme için CAD yükleyin
...
{{< blocks/products/pf/slr-element name="belgeler" href="https://docs.aspose.com/cad/java/" >}}
{{< blocks/products/pf/slr-element name="Kaynak kodu" href="https://github.com/aspose-cad/Aspose.CAD-for-Java" >}}
{{< blocks/products/pf/slr-element name="API Referansları" href="https://apireference.aspose.com/java/cad/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Neden Java için Aspose.CAD?" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.CAD " description="Aspose.CAD, aşağıda listelenen diğer popüler geliştirme ortamları için bireysel yerel API'ler sunar:" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/cad/tr/net/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/cad/aspose_cad-for-net.svg" sdkName=".NET" >}}
