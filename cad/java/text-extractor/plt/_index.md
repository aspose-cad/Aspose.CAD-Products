---
title: Text extractor PLT document via Java 
weight: 3920
url: /java/text-extractor/plt 
...
{{% blocks/products/pf/agp/content h2="How to Extracted text PLT File Using Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Extract text to PLT via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Extracted text PLT file - Java" offSpacer="" %}}

{{< gist "aspose-com-gists" "49c1b75d9a84e149ecf374ece2c2597d" "text-extractor-PLT.java" >}}
