...
{{% blocks/products/pf/agp/feature-section-col title="Convert IFC to PDF via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Java Code for IFC to PDF Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/faq imgSrc="https://www.aspose.com/templates/brand/images/cad/aspose_cad-brand.png" >}}
    ...
    {{< blocks/products/pf/agp/faq-item question="Can I convert IFC to PDF on operating systems other than Windows?" answer="You can execute the code on any operating system that has Java environment, that includes Windows, Linux and macOS." >}}
    {{< blocks/products/pf/agp/faq-item question="Can I convert IFC to PDF via .NET?" answer="Sure. Aspose.CAD is available for .NET as well. Checkout [C# code for IFC to PDF conversion](https://products.aspose.com/cad/net/conversion/ifc-to-pdf\)." >}}
    {{< blocks/products/pf/agp/faq-item question="I do not have time to set up. Do you have a demo that I can try?" answer="Indeed. Try [IFC to PDF Demo](https://products.aspose.app/cad/conversion/) to quickly check the conversion results." >}}
 
{{< /blocks/products/pf/agp/faq >}}

{{< blocks/products/pf/agp/demobox sectionTitle="[Free Online App for IFC to PDF Conversion](https://products.aspose.app/cad/conversion/ifc-to-pdf)" sectionDescription="" >}}
