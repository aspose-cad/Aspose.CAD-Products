---
title: Converteer DGN naar JPEG via Java 
url: /nl/java/conversion/dgn-to-jpeg/ 
description: Voorbeeld Java-conversiecode voor DGN-indeling naar JPEG-bestand. Gebruik deze voorbeeldcode om DGN naar JPEG te converteren binnen elke web- of desktop-Java-toepassing.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer DGN naar JPEG via Java" h2="Native Java-bibliotheek om DGN te lezen, schrijven en exporteren naar JPEG zonder Adobe." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="JPEG" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DGN" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om DGN naar JPEG te converteren via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="DGN naar JPEG Java-conversiebroncode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app om DGN naar JPEG te converteren" sectionDescription="[Convert DGN to JPEG](https://products.aspose.app/cad/conversion/dgn-to-jpeg) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
