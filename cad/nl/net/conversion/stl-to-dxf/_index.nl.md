---
title: Converteer STL naar DXF via C# 
url: /nl/net/conversion/stl-to-dxf/ 
description: Voorbeeldcode voor conversie van STL naar DXF C#. Gebruik API-voorbeeldcode voor batch-STL-bestanden naar DXF-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde toepassing.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer STL naar DXF via C#" h2="Converteer STL direct naar DXF zonder dat u AutoCAD® of andere renderingsoftware nodig heeft." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DXF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="CAD" fileiconsmall4="XML" fileiconsmall5="STL" >}}
...
Om STL naar DXF te converteren, gebruiken we <a href=https://products.aspose.com/cad/net>Aspose.CAD for .NET</a> API, een veelzijdige, krachtige en gebruiksvriendelijke API voor documentmanipulatie en -conversie voor het C#-platform. Open <a href=https://www.nuget.org/packages/aspose.cad>NuGet</a> pakketbeheerder, zoek naar Aspose.CAD en installeer. U kunt ook de volgende opdracht gebruiken vanuit de Package Manager Console.
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om STL naar DXF te converteren via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Deze voorbeeldcode toont STL naar DXF C#-conversie" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app om STL naar DXF te converteren" sectionDescription="Check our live demos for [STL to DXF conversion](https://products.aspose.app/cad/conversion/stl-to-dxf) with following benefits." >}}
