---
title: Watermark DWFX document via C# 
weight: 3920
url: /net/watermark/dwfx 
...
{{< blocks/products/pf/upper-banner h1="Add Text Watermark to DWFX via C#" h2="Build your own .NET apps to watermark DWFX files using server-side APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DWFX" pfName="Aspose.CAD" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="How to Watermark DWFX File Using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Add Watermark to DWFX via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Watermark DWFX image - .NET" offSpacer="" %}}

{{< gist "aspose-com-gists" "88cdd0899132edaf0afff77d33d11ae5" "watermark-DWFX.cs" >}}
