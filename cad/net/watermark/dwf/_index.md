---
title: Watermark DWF document via C# 
weight: 3920
url: /net/watermark/dwf 
...
{{< blocks/products/pf/upper-banner h1="Add Text Watermark to DWF via C#" h2="Build your own .NET apps to watermark DWF files using server-side APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DWF" pfName="Aspose.CAD" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="How to Watermark DWF File Using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Add Watermark to DWF via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Watermark DWF image - .NET" offSpacer="" %}}

{{< gist "aspose-com-gists" "88cdd0899132edaf0afff77d33d11ae5" "watermark-DWF.cs" >}}
