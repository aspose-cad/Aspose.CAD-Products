---
title: Convert IGEC to BMP via C# 
url: /net/conversion/igec-to-bmp/ 
description: Sample code for IGEC to BMP C# conversion. Use API example code for batch IGEC files to BMP conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/code-block title="This sample code shows IGEC to BMP C# Conversion" offSpacer="" %}}
