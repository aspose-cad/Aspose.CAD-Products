---
title: Convert CFF2 to PDF via C# 
url: /net/conversion/cff2-to-pdf/ 
description: Sample code for CFF2 to PDF C# conversion. Use API example code for batch CFF2 files to PDF conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/code-block title="This sample code shows CFF2 to PDF C# Conversion" offSpacer="" %}}
