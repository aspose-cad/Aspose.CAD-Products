---
title: Convert IGEC to PDF via C# 
url: /net/conversion/igec-to-pdf/ 
description: Sample code for IGEC to PDF C# conversion. Use API example code for batch IGEC files to PDF conversion within VB.NET, Asp.NET or any .NET based application.
---
