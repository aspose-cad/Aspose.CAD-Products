---
title: Convert STP to DXF via JavaScript
weight: 1230
url: /javascript-net/conversion/stp-to-dxf/ 
description: Sample code for STP to DXF conversion. Use API example code for batch STP files to DXF conversion.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert STP to DXF via JavaScript" h2="Instantly convert STP to DXF without needing AutoCAD® or any other rendering software." logoImageSrc="https://products.aspose.app/cad/img/platforms/aspose_cad-for-javascript-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DXF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="STP" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert STP to DXF Using JavaScript" %}}

 In order to convert STP to DXF, we’ll use [Aspose.CAD for JavaScript](https://products.aspose.com/cad/javascript-net) API which is a feature-rich, powerful and easy to use document manipulation and conversion API for JavaScript platform. Open [NPM](https://www.npmjs.com/package/aspose-cad) package manager, search for Aspose.CAD and install. You may also use the following command from the Package Manager Console. For additional information on the Javascript Framework, you can go to our [documentation site](https://docs.aspose.com/cad/javascript-net/showcases/).
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert STP to DXF via JavaScript" %}}

{{% blocks/products/pf/agp/text %}}

JavaScript programmers can easily load & convert STP files to DXF in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows STP to DXF JavaScript Conversion" offSpacer="" %}}

{{< gist "aspose-com-gists" "b5a4510e5fa49082bb585a12d753de8d" "convert-stp-to-dxf.js" >}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert STP to DXF" sectionDescription="Check our live demos for [STP to DXF conversion](https://products.aspose.app/cad/conversion/stp-to-dxf) with following benefits." >}}
