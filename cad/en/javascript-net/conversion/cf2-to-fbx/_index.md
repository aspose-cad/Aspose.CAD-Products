---
title: Convert CF2 to FBX via JavaScript
weight: 3940
url: /javascript-net/conversion/cf2-to-fbx/ 
description: Sample code for CF2 to FBX conversion. Use API example code for batch CF2 files to FBX conversion.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert CF2 to FBX via JavaScript" h2="Instantly convert CF2 to FBX without needing AutoCAD® or any other rendering software." logoImageSrc="https://products.aspose.app/cad/img/platforms/aspose_cad-for-javascript-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="FBX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CF2" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert CF2 to FBX Using JavaScript" %}}

 In order to convert CF2 to FBX, we’ll use [Aspose.CAD for JavaScript](https://products.aspose.com/cad/javascript-net) API which is a feature-rich, powerful and easy to use document manipulation and conversion API for JavaScript platform. Open [NPM](https://www.npmjs.com/package/aspose-cad) package manager, search for Aspose.CAD and install. You may also use the following command from the Package Manager Console. For additional information on the Javascript Framework, you can go to our [documentation site](https://docs.aspose.com/cad/javascript-net/showcases/).
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert CF2 to FBX via JavaScript" %}}

{{% blocks/products/pf/agp/text %}}

JavaScript programmers can easily load & convert CF2 files to FBX in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows CF2 to FBX JavaScript Conversion" offSpacer="" %}}

{{< gist "aspose-com-gists" "b5a4510e5fa49082bb585a12d753de8d" "convert-cf2-to-fbx.js" >}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert CF2 to FBX" sectionDescription="Check our live demos for [CF2 to FBX conversion](https://products.aspose.app/cad/conversion/cf2-to-fbx) with following benefits." >}}
