...
{{% blocks/products/pf/agp/content h2="How to Convert PLT to JPEG Using Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PLT to JPEG via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PLT to JPEG Python Conversion" offSpacer="" %}}
