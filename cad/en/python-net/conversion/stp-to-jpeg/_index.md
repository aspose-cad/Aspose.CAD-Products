...
{{% blocks/products/pf/agp/content h2="How to Convert STP to JPEG Using Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert STP to JPEG via Python" %}}

{{% blocks/products/pf/agp/text %}}

Python programmers can easily load & convert STP files to JPEG in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows STP to JPEG Python Conversion" offSpacer="" %}}

{{< gist "aspose-com-gists" "511bcfad674670f7484dcd1c47480b11" "convert-stp-to-jpeg.py" >}}
