...
{{% blocks/products/pf/agp/content h2="How to Convert STP to GLB Using Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert STP to GLB via Python" %}}

{{% blocks/products/pf/agp/text %}}

Python programmers can easily load & convert STP files to GLB in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows STP to GLB Python Conversion" offSpacer="" %}}

{{< gist "aspose-com-gists" "511bcfad674670f7484dcd1c47480b11" "convert-stp-to-glb.py" >}}
