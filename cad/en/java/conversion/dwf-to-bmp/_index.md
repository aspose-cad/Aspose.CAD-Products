...
description: Sample Java conversion code for DWF format to BMP file. Use this example code to convert DWF to BMP within any Web or Desktop Java based application.
---
...
In order to render DWF to BMP, we’ll use [Aspose.CAD for Java](https://products.aspose.com/cad/java) API which is a feature-rich, powerful and easy to use conversion API for Java platform. You can download its latest version directly from [Aspose Maven Repository](https://repository.aspose.com/cad/) and install it within your Maven-based project by adding the following configurations to the pom.xml.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java developers can easily convert DWF file to BMP in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="DWF to BMP Java Conversion Source Code" offSpacer="" %}}
