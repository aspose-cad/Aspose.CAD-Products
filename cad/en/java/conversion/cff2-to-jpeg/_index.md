...
description: Sample Java conversion code for CFF2 format to JPEG file. Use this example code to convert CFF2 to JPEG within any Web or Desktop Java based application.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java developers can easily convert CFF2 file to JPEG in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="CFF2 to JPEG Java Conversion Source Code" offSpacer="" %}}
