---
title: Convert DWF to DXF via Java 
weight: 40
url: /java/conversion/dwf-to-dxf/ 
description: Sample Java conversion code for DWF format to DXF file. Use this example code to convert DWF to DXF within any Web or Desktop Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert DWF to DXF via Java" h2="Instantly convert DWF to DXF from a Java application without any other rendering software." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DXF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DWF" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert DWF to DXF Using Java" %}}

In order to render DWF to DXF, we’ll use [Aspose.CAD for Java](https://products.aspose.com/cad/java) API which is a feature-rich, powerful and easy to use conversion API for Java platform. You can download its latest version directly from [Aspose Maven Repository](https://repository.aspose.com/cad/) and install it within your Maven-based project by adding the following configurations to the pom.xml.
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert DWF to DXF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert DWF file to DXF in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="DWF to DXF Java Conversion Source Code" offSpacer="" %}}

{{< gist "aspose-com-gists" "2789628881df93e0012cfad00bbc73e1" "convert-dwf-to-dxf.java" >}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="DWF to DXF Conversion Live Demos" sectionDescription="[Convert DWF to DXF](https://products.aspose.app/cad/conversion/dwf-to-dxf) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your DWF file, it will be converted instantly to DXF." >}}
