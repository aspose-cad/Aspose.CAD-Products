...
{{% blocks/products/pf/agp/content h2="How to Convert STP to GIF Using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert STP to GIF via C#" %}}

{{% blocks/products/pf/agp/text %}}

.NET programmers can easily load & convert STP files to GIF in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows STP to GIF C# Conversion" offSpacer="" %}}

{{< gist "aspose-com-gists" "fa9ce3c2849df7748c9043e827afecf1" "convert-stp-to-gif.cs" >}}
