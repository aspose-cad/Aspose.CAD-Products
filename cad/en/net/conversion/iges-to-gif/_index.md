...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert IGES to GIF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programmers can easily load & convert IGES files to GIF in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows IGES to GIF C# Conversion" offSpacer="" %}}
