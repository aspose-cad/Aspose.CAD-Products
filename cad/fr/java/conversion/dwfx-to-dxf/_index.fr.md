---
title: Convertir DWFX en DXF via Java 
url: /fr/java/conversion/dwfx-to-dxf/ 
description: Exemple de code de conversion Java pour le format DWFX en fichier DXF. Utilisez cet exemple de code pour convertir DWFX en DXF dans n'importe quelle application Java Web ou de bureau.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir DWFX en DXF via Java" h2="Bibliothèque Java native pour lire, écrire et exporter DWFX vers DXF sans avoir besoin d'Adobe." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DXF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DXF" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DWFX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir DWFX en DXF via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion DWFX vers DXF Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir DWFX en DXF" sectionDescription="[Convert DWFX to DXF](https://products.aspose.app/cad/conversion/dwfx-to-dxf) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
