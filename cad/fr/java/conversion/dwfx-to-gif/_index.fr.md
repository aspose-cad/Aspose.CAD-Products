---
title: Convertir DWFX en GIF via Java 
url: /fr/java/conversion/dwfx-to-gif/ 
description: Exemple de code de conversion Java pour le format DWFX en fichier GIF. Utilisez cet exemple de code pour convertir DWFX en GIF dans n'importe quelle application Java Web ou de bureau.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir DWFX en GIF via Java" h2="Bibliothèque Java native pour lire, écrire et exporter DWFX vers GIF sans avoir besoin d'Adobe." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="GIF" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DWFX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir DWFX en GIF via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion DWFX vers GIF Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir DWFX en GIF" sectionDescription="[Convert DWFX to GIF](https://products.aspose.app/cad/conversion/dwfx-to-gif) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
