---
title: Convertir STL en JPEG via Java 
url: /fr/java/conversion/stl-to-jpeg/ 
description: Exemple de code de conversion Java pour le format STL en fichier JPEG. Utilisez cet exemple de code pour convertir STL en JPEG dans n'importe quelle application Java Web ou de bureau.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir STL en JPEG via Java" h2="Bibliothèque Java native pour lire, écrire et exporter STL vers JPEG sans avoir besoin d'Adobe." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="JPEG" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="STL" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir STL en JPEG via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion STL vers JPEG Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir STL en JPEG" sectionDescription="[Convert STL to JPEG](https://products.aspose.app/cad/conversion/stl-to-jpeg) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
