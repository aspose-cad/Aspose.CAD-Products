---
title: Convertir IGEC en JPEG via C# 
url: /fr/net/conversion/igec-to-jpeg/ 
description: Exemple de code pour la conversion IGEC en JPEG C#. Utilisez le code d'exemple d'API pour la conversion par lots de fichiers IGEC en JPEG dans VB.NET, Asp.NET ou toute application basée sur .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir IGEC en JPEG via C#" h2="Convertissez instantanément IGEC en JPEG sans avoir besoin d'AutoCAD® ou de tout autre logiciel de rendu." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="CAD" fileiconsmall4="XML" fileiconsmall5="IGEC" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir IGEC en JPEG via C #" %}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion IGEC en JPEG C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir IGEC en JPEG" sectionDescription="Check our live demos for [IGEC to JPEG conversion](https://products.aspose.app/cad/conversion/igec-to-jpeg) with following benefits." >}}
