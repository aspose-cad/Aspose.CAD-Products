...
description: Exemple de code pour la conversion STL en PDF C#. Utilisez le code d'exemple d'API pour la conversion par lots de fichiers STL en PDF dans VB.NET, Asp.NET ou toute application basée sur .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir STL en PDF via C#" h2="Convertissez instantanément STL en PDF sans avoir besoin d'AutoCAD® ou de tout autre logiciel de rendu." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="CAD" fileiconsmall4="XML" fileiconsmall5="STL" >}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion STL en PDF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir STL en PDF" sectionDescription="Check our live demos for [STL to PDF conversion](https://products.aspose.app/cad/conversion/stl-to-pdf) with following benefits." >}}
