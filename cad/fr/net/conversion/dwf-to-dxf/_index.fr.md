---
title: Convertir DWF en DXF via C# 
url: /fr/net/conversion/dwf-to-dxf/ 
description: Exemple de code pour la conversion DWF en DXF C#. Utilisez le code d'exemple d'API pour la conversion par lots de fichiers DWF en DXF dans VB.NET, Asp.NET ou toute application basée sur .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir DWF en DXF via C#" h2="Convertissez instantanément DWF en DXF sans avoir besoin d'AutoCAD® ou de tout autre logiciel de rendu." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DXF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="CAD" fileiconsmall4="XML" fileiconsmall5="DWF" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir DWF en DXF via C #" %}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion DWF en DXF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir DWF en DXF" sectionDescription="Check our live demos for [DWF to DXF conversion](https://products.aspose.app/cad/conversion/dwf-to-dxf) with following benefits." >}}
