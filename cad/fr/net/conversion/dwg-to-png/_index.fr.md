---
title: Convertir DWG en PNG via C# 
url: /fr/net/conversion/dwg-to-png/ 
description: Exemple de code pour la conversion DWG en PNG C#. Utilisez le code d'exemple d'API pour la conversion par lots de fichiers DWG en PNG dans VB.NET, Asp.NET ou toute application basée sur .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir DWG en PNG via C#" h2="Convertissez instantanément DWG en PNG sans avoir besoin d'AutoCAD® ou de tout autre logiciel de rendu." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="CAD" fileiconsmall4="XML" fileiconsmall5="DWG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir DWG en PNG via C #" %}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion DWG en PNG C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir DWG en PNG" sectionDescription="Check our live demos for [DWG to PNG conversion](https://products.aspose.app/cad/conversion/dwg-to-png) with following benefits." >}}
