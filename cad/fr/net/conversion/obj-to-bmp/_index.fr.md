---
title: Convertir OBJ en BMP via C# 
url: /fr/net/conversion/obj-to-bmp/ 
description: Exemple de code pour la conversion OBJ en BMP C#. Utilisez le code d'exemple d'API pour la conversion par lots de fichiers OBJ en BMP dans VB.NET, Asp.NET ou toute application basée sur .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir OBJ en BMP via C#" h2="Convertissez instantanément OBJ en BMP sans avoir besoin d'AutoCAD® ou de tout autre logiciel de rendu." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="CAD" fileiconsmall4="XML" fileiconsmall5="OBJ" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir OBJ en BMP via C #" %}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion OBJ en BMP C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir OBJ en BMP" sectionDescription="Check our live demos for [OBJ to BMP conversion](https://products.aspose.app/cad/conversion/obj-to-bmp) with following benefits." >}}
