---
title: Convertir IFC en GIF via C# 
url: /fr/net/conversion/ifc-to-gif/ 
description: Exemple de code pour la conversion IFC en GIF C#. Utilisez le code d'exemple d'API pour la conversion par lots de fichiers IFC en GIF dans VB.NET, Asp.NET ou toute application basée sur .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir IFC en GIF via C#" h2="Convertissez instantanément IFC en GIF sans avoir besoin d'AutoCAD® ou de tout autre logiciel de rendu." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cad/aspose_cad-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="CAD" fileiconsmall4="XML" fileiconsmall5="IFC" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir IFC en GIF via C #" %}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion IFC en GIF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir IFC en GIF" sectionDescription="Check our live demos for [IFC to GIF conversion](https://products.aspose.app/cad/conversion/ifc-to-gif) with following benefits." >}}
