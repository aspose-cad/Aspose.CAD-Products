...
{{< blocks/products/pf/i18n/upper-banner h1=".NET API για μετατροπή αρχείων AutoCAD" h2="Μετατρέψτε αρχεία DWG και DXF σε εικόνες PDF και Raster χωρίς λογισμικό AutoCAD." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cad/headers/aspose_cad-for-net.svg" pfName="Aspose.CAD" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/cad/net" >}}
...

{
    ...
    // δημιουργήστε μια παρουσία του CadRasterizationOptions &amp; ορίστε το μέγεθος της σελίδας που προκύπτει
...
{{< blocks/products/pf/slr-tab tabTitle="Γιατί το Aspose.CAD για .NET;" tabId="success-stories" >}}
